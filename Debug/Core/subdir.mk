...
clean-Application-2f-User-2f-Core:
	-$(RM) ./Core/dma.cyclo ./Core/dma.d ./Core/dma.o ./Core/dma.su ./Core/gpio.cyclo ./Core/gpio.d ./Core/gpio.o ./Core/gpio.su ./Core/main.cyclo ./Core/main.d ./Core/main.o ./Core/main.su ./Core/rtc.cyclo ./Core/rtc.d ./Core/rtc.o ./Core/rtc.su ./Core/stm32_lpm_if.cyclo ./Core/stm32_lpm_if.d ./Core/stm32_lpm_if.o ./Core/stm32_lpm_if.su ./Core/stm32wlxx_hal_msp.cyclo ./Core/stm32wlxx_hal_msp.d ./Core/stm32wlxx_hal_msp.o ./Core/stm32wlxx_hal_msp.su ./Core/stm32wlxx_it.cyclo ./Core/stm32wlxx_it.d ./Core/stm32wlxx_it.o ./Core/stm32wlxx_it.su ./Core/subghz.cyclo ./Core/subghz.d ./Core/subghz.o ./Core/subghz.su ./Core/sys_app.cyclo ./Core/sys_app.d ./Core/sys_app.o ./Core/sys_app.su ./Core/sys_debug.cyclo ./Core/sys_debug.d ./Core/sys_debug.o ./Core/sys_debug.su ./Core/syscalls.cyclo ./Core/syscalls.d ./Core/syscalls.o ./Core/syscalls.su ./Core/sysmem.cyclo ./Core/sysmem.d ./Core/sysmem.o ./Core/sysmem.su ./Core/timer_if.cyclo ./Core/timer_if.d ./Core/timer_if.o ./Core/timer_if.su ./Core/usart.cyclo ./Core/usart.d ./Core/usart.o ./Core/usart.su ./Core/usart_if.cyclo ./Core/usart_if.d ./Core/usart_if.o ./Core/usart_if.su
